...
export const Panier = ({navigation,route})=>{
    const [produit,panier_produit,quantite_produit,addProduit,incrementProduit,decrementProduit] = panierStore((state)=>[state.produit,state.panier_produit,state.quantite_produit,state.addProduit,state.incrementProduit,state.decrementProduit])
    useState(()=>{
